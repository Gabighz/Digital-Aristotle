...
define('_SESSION_PATH_',  _ADMIN_PATH_ . "ses_05618538011b852edf2b1895{$path_separator}");
...
// Time zone settings
//------------------------------------------------------------------------
$time_zone_locale = 'Europe/London'; // a full list can be found at http://uk.php.net/manual/en/timezones.php
...
$remember_up_to = 10;
$debugemail = 'ghiuzangabriel2@gmail.com';
...
// Set Misc Data
//------------------------------------------------------------------------
$botmaster_name = 'Gabriel Ghiuzan';
$charset = 'UTF-8';
